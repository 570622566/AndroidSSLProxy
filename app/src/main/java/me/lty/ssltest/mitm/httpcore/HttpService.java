...
import org.apache.httpcore.protocol.HttpRequestHandlerResolver;
...
public class HttpService {
    ...
    private volatile HttpRequestHandler handler = null;
     ...
     * @param handler     the handler resolver. May be null.
     ...
     * @param handler             the handler mapper. May be null.
     * @param expectationVerifier the expectation verifier. May be null.
     * @since 4.3
     */
    public HttpService(
    ...
    public HttpService(
            ...
            final HttpResponseFactory responseFactory,
            final HttpRequestHandler handler) {
        this(processor, connStrategy, responseFactory, handler, null);
    }
     ...
     */
    public HttpService(
            final HttpProcessor processor, final HttpRequestHandler handler) {
