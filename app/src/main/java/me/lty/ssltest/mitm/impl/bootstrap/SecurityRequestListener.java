 ...
 * @version v1.0
 */
public class SecurityRequestListener implements Runnable {

    private static final String TAG = SecurityRequestListener.class.getSimpleName();
    ...
    public SecurityRequestListener(
